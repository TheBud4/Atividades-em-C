/*
6) Crie um algoritmo chamado Zodiaco. Este algoritmo deve ler o dia e mês do seu
aniversário e atribuir um valor para a variável inteira chamada signo, conforme lista
abaixo:
a) 1o
